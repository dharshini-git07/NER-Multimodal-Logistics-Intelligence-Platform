      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-800 bg-slate-950/60">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-100">Report Road Hazard / Cutoff</h3>
              <p className="text-xs text-slate-400">Crowdsourced & BRO Field Incident Dispatch</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 text-xs">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-slate-400 font-semibold mb-1">Impact Severity</label>
              <select
                value={severity}
          ...
          {/* Location Name */}
          <div>
            <label className="block text-slate-400 font-semibold mb-1">Location / Highway Chainage</label>
            <input
              type="text"
              value={locationName}
          ...
          {/* Description */}
          <div>
            <label className="block text-slate-400 font-semibold mb-1">Situation Description</label>
            <textarea
              rows={2}
              value={description}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-slate-400 font-semibold mb-1 flex items-center gap-1">
                <User className="w-3 h-3 text-slate-400" /> Reporter Name / Unit
              </label>
              <input
                type="text"
                value={reportedBy}
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-3 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500 text-white font-bold rounded-xl shadow-lg shadow-red-600/20 transition active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2"
            >
